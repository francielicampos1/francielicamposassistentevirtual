...
export function WhatsAppFloat() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex size-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg shadow-black/20 ring-1 ring-black/5 transition-all duration-200 hover:scale-105 hover:shadow-xl sm:bottom-7 sm:right-7"
    >
      <svg
        viewBox="0 0 32 32"
        aria-hidden="true"
