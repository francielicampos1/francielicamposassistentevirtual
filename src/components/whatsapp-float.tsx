...
export function WhatsAppFloat() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex size-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_8px_24px_-6px_rgba(37,211,102,0.44)] transition-all duration-300 ease-out hover:scale-110 hover:shadow-[0_12px_32px_-6px_rgba(37,211,102,0.56)] focus:outline-none focus:ring-2 focus:ring-[#25D366] focus:ring-offset-2 focus:ring-offset-background md:bottom-6 md:right-6 md:size-14"
    >
      <svg
        viewBox="0 0 24 24"
        fill="currentColor"
